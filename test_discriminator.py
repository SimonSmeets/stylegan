...
def get_images(nb, real):
    if real:
        path = r'C:\Users\Simon Smeets\Documents\Unief\2deMaster\Thesis\databases\NUAA\Detectedface\ClientFace'
    else:
        path = r'C:\Users\Simon Smeets\Documents\Unief\2deMaster\Thesis\databases\NUAA\Detectedface\ImposterFace'
...
def test_replay(weights, multiple = False):
    ...
    G, D, Gs = pickle.load(open(weights, "rb"))
    if multiple:
        train_images, train_labels = get_all_images(r'C:\Users\Simon Smeets\Documents\Unief\2deMaster\Thesis\databases\replay-attack\train_frames_multiple',"attack")
        test_images, test_labels = get_all_images(r'C:\Users\Simon Smeets\Documents\Unief\2deMaster\Thesis\databases\replay-attack\test_frames_multiple',"attack")
    else:
        train_images, train_labels = get_all_images(
            r'C:\Users\Simon Smeets\Documents\Unief\2deMaster\Thesis\databases\replay-attack\train_frames',
            "attack")
        test_images, test_labels = get_all_images(
            r'C:\Users\Simon Smeets\Documents\Unief\2deMaster\Thesis\databases\replay-attack\test_frames',
            "attack")
...
def test_casia(weights, multiple = False):
    ...
    if multiple:
        train_images, train_labels = get_all_images(r'C:\Users\Simon Smeets\Documents\Unief\2deMaster\Thesis\databases\casia-fasd\train_frames_multiple',"attack")
        test_images, test_labels = get_all_images(r'C:\Users\Simon Smeets\Documents\Unief\2deMaster\Thesis\databases\casia-fasd\test_frames_multiple',"attack")
    else:
        train_images, train_labels = get_all_images(
            r'C:\Users\Simon Smeets\Documents\Unief\2deMaster\Thesis\databases\casia-fasd\train_frames', "attack")
        test_images, test_labels = get_all_images(
            r'C:\Users\Simon Smeets\Documents\Unief\2deMaster\Thesis\databases\casia-fasd\test_frames', "attack")
...
#weights = r'C:\Users\Simon Smeets\Documents\Unief\2deMaster\Thesis\results\karras2019stylegan-ffhq-1024x1024.pkl'
